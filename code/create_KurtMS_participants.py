...
Usage:
    python code/create_KurtMS_participants.py --demog-file /path/to/kurtms_spinalcord_csa_with_demographics.csv
    python code/create_KurtMS_participants.py          # pathology from subject ID only
